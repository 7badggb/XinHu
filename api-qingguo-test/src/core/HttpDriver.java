...
public class HttpDriver {
	...
	public static String doGet(String url, Map<String, Object> para,CookieStore cookie) throws ParseException, IOException {
		String content = null;
	...
	public static String doGetEncoder(String url, String para) throws Exception {
		String para1 = URLEncoder.encode(para, "UTF-8");
		httpClient = HttpClients.createDefault();
		HttpGet get = new HttpGet(ReadPro.getPropValue("baseURL")+url +  para1);
		respone = httpClient.execute(get);
		HttpEntity entity = respone.getEntity();
		String content = EntityUtils.toString(entity, "utf-8");
		EntityUtils.consume(entity);
