...
public class MailUtil {
    ...
    public static void sendEmail(String subject, String body,int type) throws IOException {
        try {
        	 String server = ReadPro.getPropValue("server");
        	 String port = ReadPro.getPropValue("port");
        	 String from = ReadPro.getPropValue("from");
        	 String user = ReadPro.getPropValue("from-mail-n");
        	 String password = ReadPro.getPropValue("from-mail-p");
        	 String tomail = ReadPro.getPropValue("tomail");
